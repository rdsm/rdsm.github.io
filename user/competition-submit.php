<title>Members - Robert S Dixon</title>
<?php
...
//checks if the form has been submitted
 ...
 "png") && ($extension != "gif")) 
 		{
		//print error message
 			echo '<h1>This type of file is blocked!</h1>';
 			$errors=1;
 		}
 		else
 		{
...
//If no errors registred, print the success message
 ...
 {
 	echo "<h1>File Uploaded Successfully!<br><br>The winning character will be posted on my Homepage and my Blog!<br><br><a href=http://robertdixon.uk.ht/user>&laquo; Back to Members Area</a></h1>";
 }
