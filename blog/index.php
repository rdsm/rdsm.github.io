<title>Blog - Robert S Dixon</title>
<?php
...
class BrecksBlog {
  ...
  public $settings = array(
    ...
    "BLOG_FOOTER" => "<a href=\"http://robertdixon.uk.ht\">Copyright &copy; Robert S Dixon 2014</a><script type=\"text/javascript\" src=\"http://ajax.googleapis.com/ajax/libs/jquery/1.4.2/jquery.min.js\"></script>",
  ...
  public function __construct()
  {
    ...
    else // Display Homepage
    {
      ...
      foreach ($this->posts as $key => $post)
      {
        ...
        $all_posts .= "&nbsp;<a href=\"" . $this->createPrettyPermalink($post['Title']) . "\">...continue reading</a>";
...
<?php
    ...
    <body>
      ...
      <table cellpadding="10px"><tr>
        ...
        <td style="color:#999999; background: #f9f9f9;">
          ...
          <div>
            <b>Upgrade</b>
            <br>Blog Version: <?php echo $this->version;?><br>
  ...
  /**
   * Checks to see if Blog is installed. If not, prompts for password
