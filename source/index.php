...
if (preg_match('/^http:\/\/robertdixon\.uk.ht\/source/', $url)) {
	header('Location: http://robertdixon.uk.ht/source');
}
...
// title
$title = 'View Source - Robert S Dixon'.($url_isset ? ': '.$url : '');
$label = 'View Source';
...
<form onsubmit="location='./'+this.url.value;return false;">
	<h1>View Source</h1>
	<a href="javascript:location='http://robertdixon.uk.ht/source/'+location;" id="bookmarklet"><span>View Source</span></a>
